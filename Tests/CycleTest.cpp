...
TEST(CycleSimplifyTest, one_source_array) {
    ...
    char *end = CycleNotation::Cycle::simplify(s1_array, s1_array + 7, r1_array);
...
TEST(CycleSimplifyTest, two_source_array) {
    ...
    char *end = CycleNotation::Cycle::simplify(
            s1_array,
            s1_array + 3,
            s2_array,
            s2_array + 4,
...
TEST(CycleSimplifyTest, one_source_empty) {
    ...
    char *end = CycleNotation::Cycle::simplify(s1_array, s1_array + 1, r1_array);
...
TEST(CycleSimplifyTest, one_source_big) {
    ...
    char *end = CycleNotation::Cycle::simplify(s1_array, s1_array + 13, r1_array);
...
TEST(CycleSimplifyTest, one_source_inverse) {
    ...
    char *end = CycleNotation::Cycle::simplify(s1_array, s1_array + 10, r1_array);
...
TEST(CycleSimplifyTest, one_source_identity) {
    ...
    char *end = CycleNotation::Cycle::simplify(s1_array, s1_array + 4, r1_array);
